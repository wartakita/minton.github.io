...
timeDisplay.style.cssText = "text-align:center;margin-top:0.5rem;font-size:0.95rem;";
...
function updateTime() {
  ...
  document.getElementById('timeDisplay').textContent = `Waktu Indonesia Barat: ${timeString}`;
}
